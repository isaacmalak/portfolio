...
export function ProjectDetails({selectedProject}: {selectedProject: Project}) {
     return  <div className="w-full flex-row flex gap-2 max-h-[calc(100vh-60px)] overflow-y-scroll px-5 no-scrollbar absolute">
          {/* Description section */}
          ...
          <section className=" w-1/4  ">
            <div
              className="flex flex-col relative gap-3 my-20 overflow-y-scroll no-scrollbar"
